...
public class InterfazEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Banco DizDeJa");

        jLabel2.setText("Numero Cuenta");

        jTextField1.setText("Ingrese N° cuenta aqui");
        ...
        jLabel3.setText("Ingrese Valor para la operacion (si es mostrar saldo no ingrese nada)");

        jLabel4.setText("Selecciones Operacion");
        ...
        jButton2.setText("Girar Saldo");

        jButton3.setText("Mostrar Saldo");

        jLabel5.setText("Tipo de Cuenta");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CuentaCorriente", "CuentaVista", "CuentaRut", "CuentaAhorro" }));

        jButton4.setText("Giro Dolar");
